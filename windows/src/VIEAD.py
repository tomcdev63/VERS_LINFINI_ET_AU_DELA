...
if "nt" == os.name:
    root.wm_iconbitmap(bitmap = "G:/TAF/TOMDEV/VERS_LINFINI_ET_AU_DELA/windows/data/buzz.ico")
else:
    root.wm_iconbitmap(bitmap = "G:/TAF/TOMDEV/VERS_LINFINI_ET_AU_DELA/windows/data/buzz.xbm")
...
def Text_to_speech():
    ...
    try:
        ...
        speech.save(r'G:\TAF\TOMDEV\VERS_LINFINI_ET_AU_DELA\windows\data\geocoor.mp3')
        playsound.playsound(r'G:\TAF\TOMDEV\VERS_LINFINI_ET_AU_DELA\windows\data\geocoor.mp3', block=True)
