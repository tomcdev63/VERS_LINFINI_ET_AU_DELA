...
def Text_to_speech():
    ...
    try:
        ...
        speech.save(r'G:\TAF\TOMDEV\VERS_LINFINI_ET_AU_DELA\windows\src\geocoor.mp3')
        playsound.playsound(r'G:\TAF\TOMDEV\VERS_LINFINI_ET_AU_DELA\windows\src\geocoor.mp3', block=True)
